...
public class DefaultCommentGenerator implements CommentGenerator {
	 ...
	 * .generator.api.dom.java.CompilationUnit) wen
	 */
	public void addJavaFileComment(CompilationUnit compilationUnit) {
		MyPlugin.addFileDoc(compilationUnit);
	}
	...
	public void addComment(XmlElement xmlElement) {
		...
		if (!MyPlugin.IS_ADD_XML_COMMENT) {
			return;
		}
	...
	public void addClassComment(InnerClass innerClass, IntrospectedTable introspectedTable) {
		...
		if (MyPlugin.IS_MY_CLASS_COMMENT) {
			MyPlugin.addClassComment(innerClass, introspectedTable);
		} else {
			StringBuilder sb = new StringBuilder();
	...
	public void addFieldComment(Field field, IntrospectedTable introspectedTable,
		...
		if (MyPlugin.addFieldComment(field, introspectedTable, introspectedColumn))
			return;
	...
	public void addGetterComment(Method method, IntrospectedTable introspectedTable,
		...
		if (MyPlugin.addGetterComment(method, introspectedTable, introspectedColumn))
			return;
	...
	public void addSetterComment(Method method, IntrospectedTable introspectedTable,
		...
		if (MyPlugin.addSetterComment(method, introspectedTable, introspectedColumn))
			return;
